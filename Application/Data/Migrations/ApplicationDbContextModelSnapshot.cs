...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.MaterialTestReport", b =>
                {
                    ...
                    b.ToTable("MaterialTestReports", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.Estimate", b =>
                {
                    ...
                    b.OwnsMany("Core.Entities.Estimate.Attachments#Core.Entities.Attachment", "Attachments", b1 =>
                        {
                            ...
                            b1.ToTable("Estimates_Attachments", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("EstimateId");
                        });

                    b.OwnsMany("Core.Entities.Estimate.LineItems#Core.Entities.LineItem", "LineItems", b1 =>
                        {
                            b1.Property<string>("EstimateId")
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.OwnsMany("Core.Entities.Estimate.LineItems#Core.Entities.LineItem.Attachments#Core.Entities.Attachment", "Attachments", b2 =>
                                {
                                    ...
                                    b2.ToTable("LineItem_Attachments", (string)null);
            ...
            modelBuilder.Entity("Core.Entities.JobFile", b =>
                {
                    ...
                    b.OwnsMany("Core.Entities.JobFile.Attachments#Core.Entities.Attachment", "Attachments", b1 =>
                        {
                            ...
                            b1.ToTable("JobFiles_Attachments", (string)null);
            ...
            modelBuilder.Entity("Core.Entities.MaterialTestReport", b =>
                {
                    b.OwnsMany("Core.Entities.MaterialTestReport.Attachments#Core.Entities.Attachment", "Attachments", b1 =>
                        {
                            ...
                            b1.ToTable("MaterialTestReports_Attachments", (string)null);
